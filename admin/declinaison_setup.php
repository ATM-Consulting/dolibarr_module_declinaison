...
/**
 * 	\file		admin/advancedcomposition.php
...
require_once '../lib/declinaison.lib.php';
...
$head = declinaisonAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104080Name"),
    0,
...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("DeclinaisonWithExistantProducts").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_DECLINAISON_ALLOW_CREATE_DECLINAISON_WITH_EXISTANT_PRODUCTS">';
print ajax_constantonoff('DECLINAISON_ALLOW_CREATE_DECLINAISON_WITH_EXISTANT_PRODUCTS');
print '</form>';
print '</td></tr>';

$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("DECLINAISON_CONCAT_WITHOUT_SPACE").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_DECLINAISON_CONCAT_WITHOUT_SPACE">';
print ajax_constantonoff('DECLINAISON_CONCAT_WITHOUT_SPACE');
print '</form>';
print '</td></tr>';
...
$var=!$var;
print '<tr '.$bc[$var].'>';
print '<td>'.$langs->trans("DECLINAISON_SHOW_PARENT_INSTEAD_OF_CHILD_INTO_PDF").'</td>';
print '<td align="center" width="20">&nbsp;</td>';
print '<td align="right" width="300">';
print '<form method="POST" action="'.$_SERVER['PHP_SELF'].'">';
print '<input type="hidden" name="token" value="'.$_SESSION['newtoken'].'">';
print '<input type="hidden" name="action" value="set_DECLINAISON_SHOW_PARENT_INSTEAD_OF_CHILD_INTO_PDF">';
print ajax_constantonoff('DECLINAISON_SHOW_PARENT_INSTEAD_OF_CHILD_INTO_PDF');
print '</form>';
print '</td></tr>';
